...
const STRINGS = {
    en: {
        ...
        helpClose: "Close",
        helpIntro: "Phrases in the selected language. First match wins; otherwise the general assistant answers.",
    ...
    de: {
        ...
        helpClose: "Schließen",
        helpIntro: "Phrasen in der gewählten Sprache. Der erste Treffer gewinnt; sonst antwortet der allgemeine Assistent.",
    ...
    hu: {
        ...
        helpClose: "Bezárás",
        helpIntro: "Kifejezések a választott nyelven. Az első találat nyer; különben az általános asszisztens válaszol.",
