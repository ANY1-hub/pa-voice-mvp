...
const STRINGS = {
    en: {
        ...
        helpClose: "Close",
        helpIntro: "Everyday trigger phrases per skill in the GUI language. First match wins; otherwise the general assistant answers.",
    ...
    de: {
        ...
        helpClose: "Schließen",
        helpIntro: "Alltägliche Trigger-Sätze pro Skill in der GUI-Sprache. Der erste Treffer gewinnt; sonst antwortet der allgemeine Assistent.",
    ...
    hu: {
        ...
        helpClose: "Bezárás",
        helpIntro: "Mindennapi kulcskifejezések készségenként a felület nyelvén. Az első találat nyer; különben az általános asszisztens válaszol.",
