...
P2 remaining: indexes, blocklist leak, CORS, bcrypt 72, admin list. Already done: P2-1 mypy in CI; P0-1 SECRET_KEY placeholder reject; P1-1 superuser mutation-proof tests; P1-2 blocklist whitespace; P1-3 login rate limit; P1-4 health+DB; P1-5 audio size before body; P1-6 ffmpeg timeout; P1-7 CI deps=image; P2-5 missing model key.
