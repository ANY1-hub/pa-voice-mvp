...
P1-5 audio size before body; P1-7 CI deps=image; P1-2 blocklist whitespace; then P2 (mypy in CI first). Already done: P0-1 SECRET_KEY placeholder reject; P1-1 superuser mutation-proof tests; P1-3 login rate limit; P1-4 health+DB; P1-6 ffmpeg timeout; P2-5 missing model key.
