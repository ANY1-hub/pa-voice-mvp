...
from src.security.exceptions import MemoryWritePolicyViolation, InputValidationError
...
async def test_semantic_memory_valid_write():
    ...
    fact = await mem.add_fact("The user likes Python", importance=0.8, entities=["Python", "User"])
