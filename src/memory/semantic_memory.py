# Semantic Memory - longterm insights with Vector Search and Temporal Graph metadata
...
class SemanticMemory:
    def __init__(self, user_id: str, embeddings_adapter: EmbeddingsAdapter = None):
        self.user_id = user_id
        self.collection = db_client.db["semantic_memory"] if db_client.db is not None else None
